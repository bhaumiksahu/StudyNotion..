...
//   console.log(`course id: ${courseId}`)
  ...
  useEffect(() => {
    const count = GetAvgRating(response?.courseDetail?.ratingReviews)
  ...
  useEffect(() => {
    let lectures = 0
    response?.courseDetail?.courseContent?.forEach((sec) => {
  ...
  return (
    <>
        ...
        <div className="mx-auto flex justify-between box-content px-4 lg:w-[1024px] 2xl:relative ">
          <div className="relative z-0  mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            >
              ...
              <p className={`text-richblack-200 w-[400px]`}>{courseDescription}</p>
          ...
          {/* Courses Card */}
          <div className=" mx-auto hidden min-h-[300px] w-1/3 max-w-[310px] mt-5  lg:block">
            <CourseDetailsCard
              course={response?.courseDetail}
      ...
      <div className="mx-auto box-content  px-4 text-start text-richblack-5 lg:w-[1024px]">
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[870px]">
